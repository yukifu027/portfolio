      ...
      <div class="about" id='3'>
        ...
        <div class="about__content">
          ...
          <div class="about__sentence">
            ...
            （Rails・Swift・）React・PHPを使って、オリジナルアプリを制作中</br>
            学生時代におけるデザインへの興味から、見た目によって人の役に立つ仕事をしたいと思い</br>
            現在は、フロントエンドエンジニアとしての就職を目指しています。</br>
            コーディングだけでなく、サービスの設計から実装まで携わることができるフロントエンドエンジニア</br>
            現在、独学で書籍や動画を使いながら、デザイン/Reactといったフレームワークを学習しております。（作品は「WORKS」に記載）</br>
            </br>
            <b>自己PR</b></br>
            スキルアップへの主体的な「行動力」とユーザー目線での「当事者意識」が私の強みです。</br>
            与えられるのを待つのではなく、少しでも会社や社会に貢献できるよう継続してプログラミングやデザインを学習していきます。</br>
